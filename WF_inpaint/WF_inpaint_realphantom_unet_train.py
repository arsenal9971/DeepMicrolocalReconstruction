...
## Training
model.fit_generator(train_gen,epochs=epoches, steps_per_epoch=5600 // (2*batch_size),
                    callbacks=callbacks_list, validation_data=val_gen, validation_steps= 2000// (2*batch_size))
