## Script to perform WF extraction using unet as predicting model

import os
os.environ["CUDA_VISIBLE_DEVICES"]="0"

## Import the needed modules
from data.data_factory import generate_data_WF, DataGenerator_WF
...
pretrained = 1
path_to_model_dir = './models/unets_WF/training_0'

# Data generator
size = 256
nClasses = 180
lowd = 40
train_gen = DataGenerator_WF(batch_size, size, nClasses, lowd)
val_gen = DataGenerator_WF(batch_size, size, nClasses, lowd)
...
if pretrained==0:
    ...
    path_to_training = create_increasing_dir('./models/unets_WF', 'training')
