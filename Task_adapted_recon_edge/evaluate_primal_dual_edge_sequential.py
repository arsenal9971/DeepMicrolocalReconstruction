...
with tf.name_scope('placeholders'):
    ...
    const = 1.0 #tf.placeholder(tf.float32, shape=(), name='const')
...
base_name = 'learned_primal_dual_edge_sequential'
name = base_name + '/' + str(1.0)
...
print('const= {}, loss_tomo = {}, loss_segment = {}'.format(1.0, loss_tomography_result, loss_seg_result))
...
space.element(x_result_result.squeeze()).show(clim=[0.9, 1.1], saveto='result_{}.png'.format('seq'))
space.element(edge_result_prob_result.squeeze()).show(clim=[0.0, 1.0], saveto='segment_{}.png'.format('seq'))
plt.close('all')
